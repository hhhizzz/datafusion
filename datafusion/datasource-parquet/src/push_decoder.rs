...
//!   entry point.
//! - [`PruningPushDecoderStreamState`] is the main per-file stream driver. It owns a
...
//! [`PruningPushDecoderStreamState::into_stream`] for consumption.
...
/// Shared output handling for the serial compatibility and lookahead drivers.
...
/// fully consumed.
pub(crate) struct PruningPushDecoderStreamState {
...
impl PruningPushDecoderStreamState {
